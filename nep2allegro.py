	...
	if os.path.isfile(sys.argv[1]):
		...
		for i in range(len(structure)):
			...
			with open(fwritename,"w") as file:
				...
				freeenergy="free_energy={} ".format(structure[i][0].split()[0])
				vic=structure[i][0].split()
				viri="stress=\"{} {} {} {} {} {} {} {} {}\" ".format(vic[1],vic[4],vic[6],vic[4],vic[2],vic[5],vic[6],vic[5],vic[3])
				other_text="Properties=species:S:1:pos:R:3:forces:R:3"
				header=latt+pbc+energy+freeenergy+viri+other_text
